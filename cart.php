						 ...
						 echo"
                                        ...
                                        <tr class='cart_item'>
                                            ...
                                            <td class='product-thumbnail'>
                                                <a href='single-product.php'><img width='145' height='145' alt='poster_1_up' class='shop_thumbnail' src='upload_img/".$data['imagem'].".jpg'></a>
                                            </td>

                                            <td class='product-name'>
                                                <a href='single-product.php'>".$data['nome']."</a> 
                                            </td>

                                            <td class='product-price'>
                                                <span class='amount'>".number_format($data['precoUnitario'],2,',','.')." Kz</span> 
                                            </td>
                                            ...
                                            <td class='product-subtotal'>
                                                <span class='amount'>$total_final kz</span> 
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            <form method="post" action="#" class="shipping_calculator">
                                <h2><a class="shipping-calculator-button" data-toggle="collapse" href="#calcalute-shipping-wrap" aria-expanded="false" aria-controls="calcalute-shipping-wrap">Compras na Ustora</a></h2>
